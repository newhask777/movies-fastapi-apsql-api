...
for i in range(1, 23):
    ...
    for item in response["docs"]:
        ...
        movie.alternativeName = item["alternativeName"]
        movie.enName = item["enName"]
        movie.type = item["type"]
        movie.typeNumber = item["typeNumber"]
        movie.year = item["year"]
        movie.description = item["description"]
        movie.shortDescription = item["shortDescription"]
        movie.status = item["status"]
        movie.rating = item["rating"]
        movie.votes = item["votes"]
        movie.movieLength = item["movieLength"]
        movie.ageRating = item["ageRating"]
        try:
